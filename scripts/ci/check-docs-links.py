...
PRODUCT_DOCS = [
    ...
    ROOT / "docs" / "development" / "wave-1" / "product-1.0-wave-1-execution-plan.md",
    ROOT / "docs" / "development" / "wave-1" / "product-1.0-wave-1-issue-pack.md",
    ROOT / "docs" / "development" / "wave-1" / "product-1.0-wave-1-rfc-adr-gap-analysis.md",
    ROOT / "docs" / "development" / "wave-1" / "product-1.0-wave-1-compatibility-report.md",
    ROOT / "docs" / "development" / "wave-1" / "product-1.0-wave-1-release-readiness-checklist.md",
    ROOT / "docs" / "development" / "wave-1" / "product-1.0-wave-1-exit-evidence-bundle.md",
    ROOT / "docs" / "development" / "wave-2" / "product-1.0-wave-2-execution-plan.md",
    ROOT / "docs" / "development" / "wave-2" / "product-1.0-wave-2-issue-pack.md",
    ROOT / "docs" / "development" / "wave-2" / "product-1.0-wave-2-rfc-adr-gap-analysis.md",
    ROOT / "docs" / "development" / "wave-2" / "product-1.0-wave-2-compatibility-report.md",
    ROOT / "docs" / "development" / "wave-2" / "product-1.0-wave-2-release-readiness-checklist.md",
    ROOT / "docs" / "development" / "wave-2" / "product-1.0-wave-2-exit-evidence-bundle.md",
]
REPO_PREFIXES = (
    "docs/",
    "proto/",
