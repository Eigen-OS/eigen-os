...
- a final report with `result.summary.objective` and, when available, `result.summary.energy` or other workflow output fields promoted from `workflow_output_ref`, plus `parameters`, `method`, and `optimizer_metadata`,
