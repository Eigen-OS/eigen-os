...
| Neuro-Symbolic Compiler final contract | `1.0.0` | Compiler; Neuro-Symbolic Core | `docs/architecture/components/compiler.md`; `docs/architecture/components/neuro-symbolic-core.md`; `docs/reference/eigen-lang.md` | `proto/eigen/internal/v1/compilation_service.proto` | `src/services/eigen-compiler/tests/test_conformance_suite.py`; deterministic compiler fixtures | documented | needs-alignment |

| GNN Optimizer final contract | `1.0.0` | GNN Optimizer | `docs/architecture/components/gnn-optimizer.md` | `proto/eigen/internal/v1/optimizer_service.proto` | `src/services/optimizer/tests/test_optimizer_conformance.py`; optimizer replay fixtures | documented | needs-alignment |

| Compiler ↔ Optimizer deterministic handoff | `1.0.0` | Compiler; GNN Optimizer | `docs/architecture/components/compiler.md`; `docs/architecture/components/gnn-optimizer.md` | AQO payload schema | compiler_optimizer_integration_suite.py | planned | needs-alignment |

| Optimization explainability and confidence contract | `1.0.0` | GNN Optimizer; Observability | `docs/reference/compiler-observability-contract.md` | optimization trace schema | `optimizer_explainability_suite.py` | planned | needs-alignment |
