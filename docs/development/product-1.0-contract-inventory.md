...
| Driver Manager and QDriver final contract | `1.0.0` | Driver Manager; Kernel/QRTX | `docs/architecture/components/driver-manager.md`; `docs/reference/api/grpc-internal.md`; `rfcs/0044-phase8d-qdriver-api-v1-final-contract-and-conformance-semantics.md`; `rfcs/0045-phase8d-provider-driver-matrix-contract-and-tolerance-profiles.md`; `docs/adr/0030-phase8d-qdriver-api-v1-final-contract-and-conformance-semantics.md`; `docs/adr/0031-phase8d-provider-driver-matrix-contract-and-tolerance-profiles.md` | `proto/eigen/internal/v1/driver_manager_service.proto`; planned `docs/reference/api/qdriver.md` | `src/services/driver-manager/tests/test_qdriver_v1_conformance.py`; `src/services/driver-manager/tests/test_official_driver_matrix_fixture.py`; `src/services/driver-manager/tests/test_parity_policy_fixture.py`; `src/services/driver-manager/tests/test_parity_tolerance_suite.py`; `src/services/driver-manager/tests/test_secret_lifecycle.py` | partial | needs-alignment |
