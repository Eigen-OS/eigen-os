...
**Status:** Wave 4-aligned inventory with concrete Kernel/QRTX, compiler, QFS, REST, KB, security, observability, and Wave 5 closure mappings
...
| Intelligent runtime observability | `2.1.0` | Observability; scheduler; policy engine; driver-manager | `docs/reference/intelligent-runtime-observability-contract.md` | Prometheus/OpenTelemetry metric contract; dashboard/alert fixtures; bounded optimizer candidate evidence | `monitoring/metrics/tests/test_wave5_observability_conformance.py`; `scripts/ci/check-phase9a-gates.sh` | implemented | compatible |
...
| Optimization explainability and confidence contract | `1.0.0` | GNN Optimizer; Observability | `docs/reference/compiler-observability-contract.md`; `docs/architecture/components/observability.md` | optimization trace schema | `optimizer_explainability_fixture`; bounded metrics fixture | implemented | compatible |
