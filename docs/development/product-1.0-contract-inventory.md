...
**Status:** Wave 4-aligned inventory with concrete Kernel/QRTX, compiler, QFS, REST, KB, security, and observability slice mappings
...
| Deterministic replay and audit lineage | `1.0.0` | Kernel/QRTX; Resource Manager; QFS; Observability | `docs/architecture/components/observability.md`; `docs/architecture/components/qfs.md`; `docs/reference/orchestration-observability-contract.md`; `docs/reference/multi-device-execution-contract.md`; `docs/reference/error-model.md` | QFS audit snapshots and append-only event logs | `src/rust/crates/eigen-kernel/tests/`; `src/rust/crates/eigen-kernel/src/durable_job_store.rs`; `src/rust/crates/qrtx/src/event_log.rs` | partial | needs-alignment |
...
| Wave 5 observability conformance | `3.1.0` / `2.1.0` / `1.0.0` | Observability; Kernel/QRTX; Resource Manager; multi-device execution | `docs/architecture/components/observability.md`; `docs/architecture/components/qfs.md`; `docs/reference/orchestration-observability-contract.md`; `docs/reference/intelligent-runtime-observability-contract.md`; `docs/reference/multi-device-execution-contract.md` | `monitoring/metrics/prometheus/exporter.py` | `monitoring/metrics/tests/test_wave5_observability_conformance.py` | partial | needs-alignment |
