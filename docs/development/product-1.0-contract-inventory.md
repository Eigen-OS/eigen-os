...
| Intelligent runtime observability | `2.1.0` | Observability; scheduler; policy engine; driver-manager | `docs/reference/intelligent-runtime-observability-contract.md`; `docs/howto/intelligent-runtime-observability-runbook.md` | `monitoring/metrics/prometheus/exporter.py`; `monitoring/dashboards/intelligent_runtime_dashboard.json`; `monitoring/metrics/prometheus/intelligent-runtime-alerts.yaml` | `src/services/system-api/tests/test_observability_smoke.py`; `src/services/system-api/tests/test_optimizer_contract_fixture.py`; `src/services/benchmark-service/tests/test_optimizer_evaluation_harness.py`; `docs/development/wave-7a/product-1.0-wave-7a-exit-evidence-bundle.md` | partial | needs-alignment |
| Wave 5 observability conformance | `3.1.0` / `2.1.0` / `1.0.0` | Observability; Kernel/QRTX; Resource Manager; multi-device execution | `docs/architecture/components/observability.md`; `docs/architecture/components/qfs.md`; `docs/reference/orchestration-observability-contract.md`; `docs/reference/intelligent-runtime-observability-contract.md`; `docs/reference/multi-device-execution-contract.md` | `monitoring/metrics/prometheus/exporter.py` | `src/services/system-api/tests/test_observability_smoke.py`; `src/rust/crates/eigen-kernel/tests/`; `buf lint`; `buf breaking` | implemented | compatible |
...
| Optimization explainability and confidence contract | `1.0.0` | GNN Optimizer; Observability | `docs/reference/compiler-observability-contract.md`; `docs/architecture/components/observability.md`; `docs/reference/intelligent-runtime-observability-contract.md` | optimization trace schema; bounded trace and metric evidence | `src/services/system-api/tests/test_optimizer_contract_fixture.py`; `src/services/benchmark-service/tests/test_optimizer_evaluation_harness.py`; `src/services/system-api/tests/test_observability_smoke.py`; `docs/development/wave-7a/product-1.0-wave-7a-exit-evidence-bundle.md` | implemented | compatible |
