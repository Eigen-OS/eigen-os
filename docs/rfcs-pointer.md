...
## Phase-4 RFC set (accepted)

- Status on 2026-04-28: required Phase-4 contract RFC package is accepted and indexed; ADR synchronization remains required once implementation reaches `Implemented`.
